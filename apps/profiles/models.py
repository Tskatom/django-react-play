...
class Profile(TimeStampedUUIDModel):
    ...
    profile_photo = models.ImageField(verbose_name=_("Photo"), default="/profile_default.png")
    ...
    city = models.CharField(verbose_name=_("City"), default='Bothell', max_length=180, blank=False, null=False)
    is_buyer = models.BooleanField(verbose_name=_("Buer"), default=False, help_text=_("Are you looking to buy a property?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False, help_text=_("Are you looing to sell a property?"))
