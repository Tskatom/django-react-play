    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default='Default description .... update me please...', verbose_name='Descrption')),
                ('country', django_countries.fields.CountryField(default='United States', max_length=2, verbose_name='Countrty')),
                ('city', models.CharField(default='Bothell', max_length=100, verbose_name='city')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.CharField(max_length=250, verbose_name='IP Address')),
